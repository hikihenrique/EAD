...
% ---
\titulo{Números, um possível problema para computadores}
...
\preambulo{O objetivo de nossa pesquisa é entender e explicar se os computadores perdem a precis\~{a}o ao realizar calculos com números extensos.
